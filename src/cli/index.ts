...
const cli = meow(
  `
Usage:      npx owloops-chrome-recorder <path> [options]

Examples:   npx owloops-chrome-recorder recording.json
            npx owloops-chrome-recorder recordings/*.json
  ...
  .prompt([
    {
      ...
      name: 'files',
      message:
        'Which directory or files should be translated from Recorder JSON to owloops?',
